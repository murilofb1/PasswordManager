...
public class AdapterPasswords extends RecyclerView.Adapter<AdapterPasswords.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public MyViewHolder(@NonNull View itemView, OnRecyclerItemClick recyclerItemClick) {
            super(itemView);
            txtSiteName = itemView.findViewById(id.txtRecyclerHomeName);
            txtPassword = itemView.findViewById(id.txtRecyclerHomePassword);
            ...
            imgSiteIcon = itemView.findViewById(id.imgRecyclerHomeIcon);
